...
function denyWager(message){verdictView.textContent=message;wagerInput.classList.remove('rl-deny-5b719c50');void wagerInput.offsetWidth;wagerInput.classList.add('rl-deny-5b719c50');}
...
var brandEl=document.querySelector('.rl-brand-5b719c50');var echoEl=grab('rl-echo');if(brandEl&&echoEl){echoEl.textContent=brandEl.textContent.replace(/\s+/g,' ').trim();}
